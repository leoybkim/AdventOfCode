...
The puzzle statement can be simplified into solving a linear equations with the smallest positive integers. So to solve
this problem, we need to determine 1) if the linear equation has possible integer solutions, and 2) find the smallest
...
The $gcd(94, 22)$ must divide $8400$. The $gcd(94, 22) = 2$ and because 2 can divide 8400, there exists an integer
solution to this equation.

#### References

<a id="1">[1]</a> Bézout's
identity [https://en.wikipedia.org/wiki/B%C3%A9zout%27s_identity](https://en.wikipedia.org/wiki/B%C3%A9zout%27s_identity)